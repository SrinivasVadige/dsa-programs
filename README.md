...
7. #### [DynamicProgramming](Algorithms/DynamicProgramming)
    ...
    * [Partition Equal Subset Sum (Classic 0-1 Knapsack problem without an explicit values[])](/Algorithms/DynamicProgramming/PartitionEqualSubsetSum.java)
    * [Classic 0-1 Knapsack Problem (Weights, Values, Capacity)](/Algorithms/DynamicProgramming/Classic01KnapsackProblem.java)
