 ...
 * @since 16 May 2025
 * @link 714. Best Time to Buy and Sell Stock with Transaction Fee <a href="https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-transaction-fee/">LeetCode link</a>
 * @topics Staff, Array, Dynamic Programming, Greedy
 * @companies Google(5), Apple(2), Microsoft(4), Amazon(4), TikTok(3), Bloomberg(2)
 ...
 * @see Algorithms.DynamicProgramming.BestTimeToBuyAndSellStockWithCooldown
 */
public class BestTimeToBuyAndSellStockWithTransactionFee {
    public static void main(String[] args) {
        ...
        System.out.println("maxProfitUsingStateMachineDpEffectiveBuyPrice => " + maxProfitUsingStateMachineDpEffectiveBuyPrice(prices, fee));
    ...
    /**
      ...
      same as {@link Algorithms.DynamicProgramming.BestTimeToBuyAndSellStockII#maxProfitUsingStateMachineDpEffectiveBuyPrice(int[])}
     */
    public static int maxProfitUsingStateMachineDpEffectiveBuyPrice(int[] prices, int fee){
