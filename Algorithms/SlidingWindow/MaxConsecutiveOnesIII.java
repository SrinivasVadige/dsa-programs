 ...
 * @since 12 April 2025
 * @link 1004. Max Consecutive Ones III <a href="https://leetcode.com/problems/max-consecutive-ones-iii/">LeetCode link</a>
 * @topics Senior Staff, Array, Binary Search, Sliding Window, Prefix Sum, Weekly Contest 126
 * @description Given a binary array nums, return the maximum number of consecutive 1's in the array -> you can flip only k 0s to 1s
 * For example, nums = [1,1,0,0,1,1,1,0,1,1], k=1 => 6
 * @see Algorithms.SlidingWindow.MaxConsecutiveOnes
 */
class MaxConsecutiveOnesIII {
    public static void main(String[] args) {
        int[] nums = {1,1,0,0,1,1,1,0,1,1};
        int k = 2;
        System.out.println("maxConsecutiveOnes using Sliding window 1: " + longestOnesUsingSlidingWindow1(nums, k));
    }

    public static int longestOnesUsingSlidingWindow1(int[] nums, int k) {
